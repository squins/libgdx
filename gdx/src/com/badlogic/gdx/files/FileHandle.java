...
public class FileHandle {
	...
	public FileHandle (String fileName) {
		// DISABLED: performance System.out.println("FileHandle 1, fileName: " + fileName);
		this.file = new File(fileName);
		// DISABLED: performance System.out.println("After new File");
	...
	public FileHandle (File file) {
		// DISABLED: performance System.out.println("FileHandle 2");
		this.file = file;
		this.type = FileType.Absolute;
	}

	protected FileHandle (String fileName, FileType type) {
		// DISABLED: performance System.out.println("FileHandle 3");
		this.type = type;
		file = new File(fileName);
	}

	protected FileHandle (File file, FileType type) {
		// DISABLED: performance System.out.println("FileHandle 4");
		this.file = file;
		this.type = type;
	}
