...
public class Mesh implements Disposable {
	...
	public void bind (final ShaderProgram shader, final int[] locations) {
		// DISABLED: performance System.out.println("bind with shader and intArray locations");
		vertices.bind(shader, locations);
		// DISABLED: performance System.out.println("vertices.bind(shader, locations);");
		if (instances != null && instances.getNumInstances() > 0) instances.bind(shader, locations);
		// DISABLED: performance System.out.println("after instances != null");
		if (indices.getNumIndices() > 0) indices.bind();
		// DISABLED: performance System.out.println("after bind with shader and intArray locations");
	}
	...
	public void render (ShaderProgram shader, int primitiveType, int offset, int count, boolean autoBind) {
		// DISABLED: performance System.out.println("render called, auto bind is " + autoBind);
		if (count == 0) return;

		if (autoBind) bind(shader);
		// DISABLED: performance System.out.println("before isVertexArray");
		if (isVertexArray) {
			if (indices.getNumIndices() > 0) {
				...
				// DISABLED: performance System.out.println("after first glDrawElements");
				buffer.position(oldPosition);
				buffer.limit(oldLimit);
			} else {
				Gdx.gl20.glDrawArrays(primitiveType, offset, count);
				// DISABLED: performance System.out.println("after glDrawArrays");
			}
			// DISABLED: performance System.out.println("between isVertexArray");
		} else {
			int numInstances = 0;
		...
		// DISABLED: performance System.out.println("after isVertexArray");

		if (autoBind) unbind(shader);
		// DISABLED: performance System.out.println("after render mesh");
	}
